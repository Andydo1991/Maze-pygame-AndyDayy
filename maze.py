...
class Food:
    def __init__(self):
        # Load the food image
        self.img = pygame.image.load("data/food.png").convert_alpha()
...
bg_game = pygame.image.load("data/bg_1.png").convert()
...
while True:
    ...
    surface.blit(
        text_font.render("ThoiGian", True, pygame.Color("cyan"), True), (WIDTH + 8, 30)
    )
    surface.blit(font.render(f"{time}", True, pygame.Color("cyan")), (WIDTH + 70, 130))
    surface.blit(
        text_font.render("Diem:", True, pygame.Color("forestgreen"), True),
        (WIDTH + 50, 350),
    )
    surface.blit(
    ...
    surface.blit(
        text_font.render("Tong:", True, pygame.Color("magenta"), True),
        (WIDTH + 30, 620),
    )
    surface.blit(
